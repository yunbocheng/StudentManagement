...
<div>
    ...
    <div class="body_two">
        ...
        <div class="body_tail">
            <div class="update">
                <div class="function">更改密码</div>
            </div>
            <div class="content" align="center">
                <span style="color: red;font-size: 20px;">${point}</span>
                <div class="divOne">
                    <form action="${path }/Tc_update" method="post">
                        <input type="hidden" name="status" value="TcUpdate">
                        管理员姓名：<input type="text" name="name" value="${name}" readonly="readonly" class="common"><br>
                        新密码： &nbsp;&nbsp;&nbsp;&nbsp; <input type="password" name="password" class="common"><br>
                        确认密码： &nbsp;&nbsp;<input type="password" name="password1" class="common"><br>
