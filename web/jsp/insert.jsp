...
<div>
    ...
    <div class="body_two">
        ...
        <div class="body_tail">
            <div class="update">
                <div class="function">录入学生信息</div>
            </div>
            <div class="content" align="center">
                <span style="color: red;font-size: 20px;">${mistake}</span>
                <div class="divOne">
                    <form action="${path }/Insert" method="post">
                        <input type="hidden" name="status" value="insert">
                        学号：&nbsp;&nbsp;<input type="text" name="num" class="common"><br>
                        ...
                        班级：&nbsp;&nbsp;<input type="text" name="room" class="common"><br>
                        省份：&nbsp;&nbsp;<input type="text" name="province" class="common"><br>
                        市区：&nbsp;&nbsp;<input type="text" name="city" class="common"><br>
                        <input type="submit" value="录入" class="button" style="margin-left: 55px;margin-top: 15px">
