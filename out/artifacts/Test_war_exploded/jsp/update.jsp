...
<div>
    ...
    <div class="body_two">
        ...
        <div class="body_tail">
            <div class="update">
                <div class="function">修改学生信息</div>
            </div>
            <div class="content" align="center">
                <span style="color: red;font-size: 20px;">${modify}</span>
                <div class="divOne">
                    <form action="${path }/Update" method="post">
                        <input type="hidden" name="status" value="update">
                        学号：&nbsp;&nbsp;<input type="text" name="num" value="${num}" readonly="readonly" class="common"><br>
                        姓名：&nbsp;&nbsp;<input type="text" name="name" class="common"><br>
                        年龄：&nbsp;&nbsp;<input type="text" name="age" class="common"><br>
                        分数：&nbsp;&nbsp;<input type="text" name="score" class="common"><br>
                        班级：&nbsp;&nbsp;<input type="text" name="room" value="${room}" readonly="readonly" class="common"><br>
                        省份：&nbsp;&nbsp;<input type="text" name="province" class="common"><br>
                        市区：&nbsp;&nbsp;<input type="text" name="city" class="common"><br>
                        <input type="submit" value="保存" class="button" style="margin-left: 55px;margin-top: 15px">
